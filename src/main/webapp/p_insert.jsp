...
function insert_product() {
	...
	document.pf.action = "p_insert_action.jsp";
    ...
    <jsp:include page="/include/top_header_include.jsp"></jsp:include>
		...
		<div> <!-- content -->
			<table style="padding-left: 10px" border=0 cellpadding=0
								cellspacing=0>
								<tr>
									<td bgcolor="f4f4f4" height="22">&nbsp;&nbsp;<b>상품 등록</b></td>
								</tr>
							</table>
			<form  id="pf" name="pf" method="post" enctype="multipart/form-data">
						...
						<td width=100 align=center bgcolor="E6ECDE" height="33">상품 설명</td>
										<td width=490 align="left" bgcolor="ffffff"
											style="padding-left: 10px"><textarea wrap="soft"
												style="width: 400px" rows="10" name="p_detail"></textarea>
										</td>
					</tr>
				</table>
			</form>
				<table width=590 border=0 cellpadding=0 cellspacing=0>
					<tr>
						<td align=center><input type="button" value="상품등록"
							onClick="insert_product();"> &nbsp; <input type="button"
