...
<%
	...
	if(request.getMethod().equalsIgnoreCase("GET")){
		...
		out.println("location.href='q_modify.jsp'");
		out.println("</script>");	
		return;
	}
	...
	try{
		...
		qnaService.updateQna(new Qna(Integer.parseInt(no),title,content,catergory,null,new Member(writer,null,null,null,null,null),new Product(1, null, 0, null, 0, null, null, null, 0)));
		
		response.sendRedirect("q_view.jsp?q_no="+no);	
