...
<html>
	<head>
		...
		<script>
			function goWrite() {
				...
				frm.action = "review_write_action.jsp";
				frm.method="POST";
				frm.submit();
			}
			
			function check(){
				f = document.getElementById("review_write")
				var p_no = f.p_no.value;
				alert("작성하신 리뷰가 저장되지않습니다.\n그래도 괜찮으시겠습니까?");
	...
	<body>
		...
		<section class="py-5 container px-4 px-lg-5 mt-5">
			<form id="review_write" method="post" action="review_write_action.jsp">
				<!-- 작성자, 제목 -->
