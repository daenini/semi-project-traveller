...
import com.itwill.traveller.review.ReviewListPageDto;
...
//	 페이지에 [처음으로] 아이콘 출력여부를 판단하는 메소드
	  ...
	  public static void main(String[] args) {
		  ...
		  */
		  int selectPage =8; // 현재 페이지 받아와야함
		  int rowCountPerPage=5; // 내가 설정
		  int pageCountPerPage=3; // 내가 설정
		  int totalRecordCount=563; // 받아와야 함
